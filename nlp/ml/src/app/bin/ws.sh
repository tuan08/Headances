...
JAVA_OPTS="-server -XX:+UseParallelGC -Xshare:auto -Xms128m -Xmx2024m"
JAVA_OPTS="$JAVA_OPTS -XX:ParallelGCThreads=4 -XX:+UseCompressedOops"
CLASS='org.headvances.ml.nlp.ws.statistic.WTagStatistic'
