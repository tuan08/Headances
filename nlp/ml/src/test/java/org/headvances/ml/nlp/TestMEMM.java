...
public class TestMEMM extends TestCase {
	...
	public void testSpaceMaximizable() {
		...
		memmt.train (training, 5);  // Set weights dimension, gathers training sets, etc.
	...
	public void doTestSpacePrediction(boolean testValueAndGradient, boolean useSaved, boolean useSparseWeights) {
		...
		if(useSparseWeights) crf.setWeightsDimensionAsIn(lists[0]);
		else crf.setWeightsDimensionDensely();
	...
	public static void main(String[] args) throws Exception {
		...
		//tm.testGetSetParameters();
		tm.testSpaceMaximizable();
		//tm.doTestSpacePrediction(false);
		return;
	}
}
