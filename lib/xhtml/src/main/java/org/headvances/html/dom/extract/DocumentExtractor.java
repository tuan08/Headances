...
import org.headvances.html.dom.tagger.JunkTextBlockTagger;
...
public class DocumentExtractor {
	final static public String[] CLASSIFIED_KEYWORD = {
		"Giá:", "giá bán", "price", "Địa chỉ", "mobile", "Đăng lúc", "Khu vực", "Ngày đăng",
		"Người đăng tin", "Người đăng", "Mã Tin", "Khu vực", "Đăng tại", 
		"Liên hệ qua email", "Di động"
	} ;
	
	final static public String[] PRODUCT_KEYWORD = {
		"giá", "giá hãng", "giá bán", "giá online", "price", "Giá niêm yết", 
		"Khuyến mại", "Bảo hành", "Kho", "Số lượng", "Mô tả",
		"Mã sản phẩm", "Mã hàng", "Dòng sản phẩm", "Màu sản phẩm", "Chi tiết",
		"(Đã bao gồm VAT)", "Đang còn hàng", "Áp dụng tại"
	} ;
	
	final static public String[] JOB_KEYWORD = {
		"Bằng cấp", "Kinh nghiệm", "Vị trí", "Cấp bậc","Yêu cầu trình độ",
		"Loại hình công việc", "Ngành nghề", "Mô tả công việc", "Chức danh cần tuyển",
		"Tên công ty", "Địa điểm làm việc", "Nơi làm việc",
		"Mức lương", 
