...
function report() {
  ...
  CLASS='org.headvances.html.text.svm.wptype.WPTypeReport'
...
function cvalidation() {
  JAVA_OPTS="-server -XX:+UseParallelGC -Xshare:auto -Xms128m -Xmx1024m"
  CLASS='org.headvances.html.text.svm.wptype.WPTypeCrossValidation'
...
function classifier() {
  JAVA_OPTS="-server -XX:+UseParallelGC -Xshare:auto -Xms128m -Xmx1024m"
  CLASS='org.headvances.html.text.svm.wptype.WPTypeClassifier'
